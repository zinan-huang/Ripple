...
\paragraph{The scalar-cubic case.} A separate unfinished conjecture
concerning uniform dual-railing thresholds for the scalar cubic
$y' = 1 - y^3$ (UCNC 2025 Problem 1) was treated in a companion note
\cite{scalar-cubic}. That work addresses the same zero-init regime but for
a dual-rail construction, and uses the non-collapse behavior of the present
theorem only indirectly.
...
\bibitem{scalar-cubic}
X.~Huang and Z.~Huang.
\newblock Constant-$k$ dual-railing of the scalar cubic.
\newblock Ripple project notes, 2026-04-20.
